      ...
      <Container maxWidth="sm" sx={{ my: 2 }}>
          ...
          <li>
            ...
            <ul style={{ marginTop: "10px" }}>
              ...
              <li>
                ...
                too, enjoy! More info{" "}
                <a href="https://forums.app.titanplus.cn/t/lpw-stable-diffusion-pipeline-longer-prompts-prompt-weights/82">
                  here
                </a>
                .
              </li>
        ...
        <ul>
          ...
          <li>
            ...
            <ul style={{ marginTop: "10px" }}>
              <li>
                SD-MUI is now <b>app.titanplus.cn</b>. New name, new domain, see the{" "}
