...
import Controls, { randomizeSeedIfChecked } from "../src/sd/Controls_report";
...
export default function Txt2Img() {
  ...
  url = "https://xmp-dev.titanplus.cn/img/report.html";
  ...
  async function go(event: React.SyntheticEvent) {
    ...
    setUrl("https://xmp-dev.titanplus.cn/img/report.html");
